...
\juradoDOS{Mg. Ing. Christian Marcelo Yanez Flores (INTI-FIUBA)} % Nombre y pertenencia del un jurado se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \jur2name
\juradoTRES{Esp. Ing. Lionel Gutiérrez (FIUBA)} % Nombre y pertenencia del un jurado se usa en la carátula y se puede usar el cualquier lugar del documento con el comando \jur3name
...
Para lograr este trabajo, se emplearon conocimientos especializados en protocolos de comunicación, arquitectura y pruebas de \emph{software}, arquitectura de datos y ciberseguridad.
